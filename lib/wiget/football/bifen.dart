...
class bifen extends StatefulWidget {
  Function callBack;
  Map games;
  String e2;
  int e;
...
class _ChildState extends State<bifen> {
  @override
  void initState() {
    super.initState();
  }
...
getScore(){
  ...
  getText_(){
    String str = "";
    List list = widget.games[widget.e2][widget.e]["check_info"][2]["bet_way"];
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: str != "请选择比分投注"?Colors.red:Colors.white,
          border: Border.all(width: 0.3, color: Colors.grey)),
      alignment: Alignment.center,
      width: ScreenUtil().setWidth(320),

      child: Text(str,style: TextStyle(color: str != "请选择比分投注"?Colors.white:Colors.grey),),
    );
  }
  getScoreList(state) {
