...
class Login_ extends State<forgetPassword> {
    ...
    return FlutterEasyLoading(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("忘记密码",style: TextStyle(fontSize: ScreenUtil().setSp(18)),),
        ),
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    ResultData result = await HttpManager.getInstance().post(
                        ...
                        params: {"account": phone,"captcha":validate_code,"password":password},
                        withLoading: true);
  ...
  void ontap() async{
    ...
    ResultData res_ = await HttpManager.getInstance().post("register/verify",params: {"phone":phone,"key":key});
    if(res_.code == 200){
